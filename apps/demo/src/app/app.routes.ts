...
export const AppRoutes: Routes = [
  ...
  {
    path: 'experimental',
    loadChildren: () => import('./pages/experimental-page/experimental-page.module').then(m => m.ExperimentalPageModule),
  ...
  {
    path: 'customization',
    loadChildren: () => import('./pages/customization-page/customization-page.module').then(m => m.CustomizationPageModule),
